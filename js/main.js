...
nav__links.forEach((boton) => {
    ...
    boton.addEventListener("click", (e) => {
        ...
        if (e.currentTarget.id != "todos") {
            const producto_titulo = productos.find(producto => producto.categoria === e.currentTarget.id);
            ...
            if (producto_titulo) {
                ...
                console.log("Producto no encontrado para la categoría:", e.currentTarget.id);
            }
        } else {
